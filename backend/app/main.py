...
# CORS middleware - always use explicit origins for security
# Set ALLOWED_ORIGINS env variable for production domains
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=ALLOWED_ORIGINS,  # Always explicit - no wildcards
